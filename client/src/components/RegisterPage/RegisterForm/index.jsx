...
export default function RegisterForm() {
  ...
  return (
    <div>
      <form className="flex flex-col justify-center items-center mt-32 gap-y-2 sm:gap-y-4 xl:gap-y-6 2xl:mt-56 2xl:float-right 2xl:mr-20 2xl:gap-y-10 3xl:float-none 3xl:ml-20 3xl:mt-56">
        <input
